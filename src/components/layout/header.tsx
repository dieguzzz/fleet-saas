    ...
    <header className="h-14 bg-card border-b border-border flex items-center gap-3 px-4 shrink-0">
      ...
      <div className="flex items-center gap-2">
        ...
        {user?.is_super_admin && (
          <Link
            href="/admin"
            className="hidden sm:flex items-center gap-1.5 px-2.5 py-1.5 bg-violet-100 text-violet-700 dark:bg-violet-900/30 dark:text-violet-300 rounded-lg text-xs font-semibold hover:bg-violet-200 dark:hover:bg-violet-900/50 transition-colors"
          >
